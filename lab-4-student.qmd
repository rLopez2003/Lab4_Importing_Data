...
write_csv(buoy_data_clean, "data-raw/buoy_update.csv")
...
buoy_char <- read_csv(
  "data-raw/buoy_update.csv",
  col_types = cols(.default = col_character()),
  na = c("99", "999", "9999", "999.0", "99.0")
)
...
ggplot(buoy_final, aes(x = mm, y = atmp, color = as.factor(mm))) +
  geom_jitter(alpha = 0.2, width = 0.20, size = 2) +
